...
> Design notes for **phone-otp-checkout-otp-phone-ecommerce-typescript-m** — a runnable typescript example that Typed phone OTP checkout flow with zod validation.
...
- **Feature code** — the actual task: OTP checkout.
